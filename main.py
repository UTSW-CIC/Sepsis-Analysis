...
from src.config import (input_output_config, feature_config, SIRSConfig,
                         OrganDysfunctionConfig, organdysfunction_config, vent_config, septicshock_config)


from src.utils.logger import get_logger, setup_root_logger
from src.utils.utils import save_df, load_df, join_baselines_2_agg
...
if __name__ == "__main__":
    ...
    dl = DataLoader(input_output_config.data_path)
    df_all = dl.load_data()
    ...
    df_infect = InfectionDetection(df_all).detect_infection()
